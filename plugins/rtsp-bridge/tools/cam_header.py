...
VERBATIM LIFT of core-driver/cam_driver/transport.py (this image doesn't ship cam_driver) -- the
header layout below is the frozen v1 contract, so drift is a wire break, not a style issue. If the
core ever bumps `version`, re-copy this file.
