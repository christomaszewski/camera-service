...
#     tag        default: jp7   (cam-up pulls <registry>/<img>:<platform>, i.e. jp7 on a JP7 box). rig
...
TAG="${2:-jp7}"
# cam-core base + the default image set default from the tag: jp6 -> slim l4t-base + includes the Noetic
